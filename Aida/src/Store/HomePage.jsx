...
import { Activity, BookFill, BuildingsFill, HandbagFill, HouseFill, Mouse2Fill, Truck } from "react-bootstrap-icons";
      ...
      <div className=" flex flex-col">
        ...
        <div className=" bg-IceBlue">
          ...
          icon={<svg
              ...
              <CardSlider
              styles="  sm:w-[4/5] md:w-[2/5] h-[300px]"
            >
          ...
          <Shelf shelfName={"Recommended for you"} 
          icon = {<Star color = "#FFFFFF" size="20" full = {true} disabled={true}/>}
           >
