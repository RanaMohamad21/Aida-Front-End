...
import CardBackground from "../assets/User/CardBackground.jpeg";
      ...
      <div>
        ...
        <div className="flex ">
          <div className="flex my-4   rounded-xl ">
            <div
              className="bg-lightseagreen opacity-60 text-white flex items-center hover:bg-lightseagreen hover:opacity-50 cursor-pointer rounded-tl-xl rounded-bl-xl"
           ...
           <div
              className="bg-salmon h-[197px] w-80 relative rounded-xl "
              style={{
            ...
            <div
              className="bg-lightseagreen opacity-60 text-white flex items-center hover:bg-lightseagreen hover:opacity-50 cursor-pointer rounded-tr-xl rounded-br-xl"
...
//     // Combine masked and unmasked parts
//     const combined = `${maskedDigits}${last4Digits}`;
...
//             <div
//               className="bg-salmon h-[197px] w-80 relative"
//               style={{
...
//             >
//               {/* Black overlay with 50% opacity */}
//               <div className="absolute inset-0 bg-shadowTeal opacity-75 z-0"></div>

//               <div className="relative z-10 grid grid-rows-3 text-white px-2">
//                 <div className="w-full flex my-1 justify-between items-center">
//                   <input
//                     type="text"
//                     className={`text-[18px] font-[550] ${
//                       editCard
...
//                       onClick={handleUpdateCard}
//                     >
//                       <IoCheckmarkDone style={{ fontSize: "25px" }} />
//                     </span>
//                   ) : (
//                     <span
//                       title="Edit"
//                       className="cursor-pointer hover:text-IceBlue text-black"
//                       onClick={() => setEditCard(!editCard)}
//                     >
//                       <FaPen style={{ fontSize: "25px" }} />
//                     </span>
...
//         <div
//           className=" bg-teal py-1 px-2 rounded-xl text-white w-max cursor-pointer hover:bg-shadowTeal"
//           onClick={() => setaddCard(!addCard)}
//         >
//           Add Card
//         </div>
