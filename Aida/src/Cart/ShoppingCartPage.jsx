...
import dummyImage from "../assets/dummy/dummy3.jpeg"
...
function ShoppingCartPage() {
    ...
    <div className="grid grid-rows-[auto,1fr]">
      ...
      <div className="grid grid-cols-[1fr,auto]  p-4  ">
        ...
        <p className=" text-3xl text-teal ">Shopping Cart</p>
          <div className=" flex items-center justify-center  w-[70%] h-[200px] border-t-2
          ...
          <div className="  w-[400px] flex flex-col justify-between pt-6">
            ...
            <input type= "text" className=" border border-solid  border-gray px-2 w-[40px] h-max" placeholder="00" disabled/> 
            <p className=" text-FlamingoPink">Discount
            </p>
            <span className=" text-xl text-FlamingoPink">00%</span>
                </div>

           <div>
           <p className=" flex justify-end text-FlamingoPink gap-3 py-4">points gained: <span>100</span></p>
           </div>
          </div>
          ...
          <Link to="/">
            <span className="flex text-xl text-teal pb-24    hover:ml-2 transition-all duration-1000 hover:text-FlamingoPink">
              <span className=" mt-1 pr-1 "><ChevronLeft /></span>
  ...
  <div className=" border-l-[3px] border-t-[3px] border-t-teal border-l-teal border-opacity-20 rounded-xl flex flex-col items-center justify-center w-full gap-4 mb-24">
    <img src={cartImage} alt = {"Cart image"} className=" w-full object-cover rounded-xl"/>
    ...
    <Button background={'FlamingoPink'} width={'w-[70%]'} style={' text-xl'}>Proceed</Button>
